# """
# URL configuration for career_dendrogram project.
...
# urlpatterns = [
#     path('admin/', admin.site.urls),
#     path('', include('careers.urls')),  # Includes the URLs from the careers app
#     path('accounts/', include('django.contrib.auth.urls')),  # Handles auth URLs
# ]
